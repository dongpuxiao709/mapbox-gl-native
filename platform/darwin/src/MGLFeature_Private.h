...
/**
 Returns an `MGLFeature` object converted from the given mbgl::FeatureGeoJSON
 */
MGL_EXPORT
...
/**
 Takes an `mbgl::FeatureGeoJSON` object, an identifer, and attributes dictionary and
